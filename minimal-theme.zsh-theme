...
if (( $+functions[zpm] )); then #DO_NOT_INCLUDE_LINE_IN_ZPM_CACHE
  zpm load zpm-zsh/material-colors,async zpm-zsh/pr-is-root,async zpm-zsh/pr-user zpm-zsh/pr-return,async zpm-zsh/pr-exec-time,async zpm-zsh/pr-git,async zpm-zsh/pr-cwd,async zpm-zsh/pr-php,async zpm-zsh/pr-rust,async zpm-zsh/pr-node,async zpm-zsh/pr-2,async zpm-zsh/pr-eol,async zpm-zsh/pr-zcalc,async zpm-zsh/pr-correct,async #DO_NOT_INCLUDE_LINE_IN_ZPM_CACHE
